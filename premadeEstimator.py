...
def main(argv):
    ...
    # Fetch the data
    (train_x, train_y), (test_x, test_y) = matchData.load_data()
    ...
    # Train the Model.
    classifier.train(
        input_fn=lambda:matchData.train_input_fn(train_x, train_y,
                                                 args.batch_size),
        steps=args.train_steps)

    # Evaluate the model.
    eval_result = classifier.evaluate(
        input_fn=lambda:matchData.eval_input_fn(test_x, test_y,
                                                args.batch_size))
